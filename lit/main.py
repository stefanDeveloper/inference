...
def main():
    ...
    parser.add_argument(
        "-m", "--models", nargs="+", help="<Required> Path of models", required=True
    )
    parser.add_argument(
        "-d", "--datasets", nargs="+", help="<Required> Path of datasets", required=True
    )
    parser.add_argument(
        "-c", "--cache_dir", help="<Required> Cache directory", required=True
    )
    parser.add_argument(
        "-v", "--verbose", help="Also print debug statements", action="store_true"
    )
